...
export {getAllTiers,getTierById,getUserRows,DeleteTier,getUserTiers,updateUserRows,getUsersTiers,UploadTier,getAuthorTiersSize,getAuthorTiers} from "./requests/gamecriticAPI/tierData.requests"
