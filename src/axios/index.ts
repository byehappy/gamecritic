...
export {getAllTiers,getTierById,getUserRows,getUserTiers,updateUserRows,getUsersTiers,UploadTier,getAuthorTiersSize,getAuthorTiers} from "./requests/gamecriticAPI/tierData.requests"
